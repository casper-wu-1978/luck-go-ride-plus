...
import { Car, Hash, X } from "lucide-react";
    ...
    <div className="space-y-4">
      ...
      {callRecords.length > 0 && (
        <div className="space-y-3">
          <h3 className="text-lg font-semibold text-gray-800">目前叫車記錄</h3>
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-medium">{record.carTypeLabel}</span>
                    ...
                    {record.driverInfo && (
                      <div className="text-sm text-green-700 bg-green-50 p-2 rounded">
                        司機：{record.driverInfo.name}
                        {record.driverInfo.phone && ` | 電話：${record.driverInfo.phone}`}
                      </div>
                    )}
                  </div>
